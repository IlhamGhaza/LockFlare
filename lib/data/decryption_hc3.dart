...
class DecryptionHillCipher3 {
  ...
  DecryptionHillCipher3(String keyInput) {
  ...
  String decrypt(String input) {
    ...
    // Bagi ciphertext menjadi blok 3 elemen
    List<List<int>> blocks = [];
    for (int i = 0; i < ciphertextNumerical.length; i += 3) {
      blocks.add(ciphertextNumerical.sublist(
          i, min(i + 3, ciphertextNumerical.length)));
    }
